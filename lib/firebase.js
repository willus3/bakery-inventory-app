...
// ─── 5. Export the database so other files can use it ────────────────────────
// Any file that needs to read or write data will do:
//   import { db } from "@/lib/firebase"
// They get the same connected instance without re-initializing anything.
export { db };
